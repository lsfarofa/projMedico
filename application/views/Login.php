...
<body>
  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <form id="c_form-h" class="" method="post" action="<?php echo site_url('Login/cadastrar')?>">
            ...
            <div class="form-group row"> 
              ...
              <div class="col-10">
                <input type="password" class="form-control" id="senha" name="senha" placeholder="SENHA"> </div>
            </div>
